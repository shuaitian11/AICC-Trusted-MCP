...
The server implementations provide the same three TDX-oriented tools:
...
```bash
cd /home/yunge/AICC-Trusted-MCP/demo/mcp_tdx_demo
...
```bash
export PYTHONPATH=/home/yunge/AICC-Trusted-MCP:$PYTHONPATH
```
